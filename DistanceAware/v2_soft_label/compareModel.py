"""
Streamlined External Benchmark: Distance-Aware Chronos v2 vs Original
...
class BenchmarkConfig:
    ...
    distance_aware_repo: str = "Phoenix21/distance-aware-chronos-t"
...
class ModelLoader:
    ...
    def load_models(self) -> Tuple[object, object]:
        ...
        state_dict = torch.load(distance_output_path, map_location=self.device, weights_only=True)
...
def main():
    ...
    config = BenchmarkConfig(
        distance_aware_repo="Phoenix21/distance-aware-chronos-t",
